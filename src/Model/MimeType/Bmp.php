 ...
 * @ Description: Bmp file netity
 */

final class Bmp implements MimeTypeInterface, FileInterface
{
    public const MIME_TYPE = 'image/bmp';
    public const EXTENSION = '.bmp';
    ...
    public static function resize(FileInterface $file, $w, $h, $crop = FALSE): self
    {
        ...
        $src = imagecreatefrombmp($file->path(true));
        $dst = imagecreatetruecolor($newwidth, $newheight);
        imagecopyresampled($dst, $src, 0, 0, 0, 0, $newwidth, $newheight, $width, $height);

        return new Bmp($dst, $file);
    }
    ...
    {   
        ...
        if(imagebmp($this->image,$fullPath,$quality)) {
            return true;
        }
