 ...
 * @ Description: Giff file netity
 */

final class Giff implements MimeTypeInterface, FileInterface
{
    public const MIME_TYPE = 'image/giff';
    public const EXTENSION = '.giff';
    ...
    public static function resize(FileInterface $file, $w, $h, $crop = FALSE): self
    {
        ...
        $src = imagecreatefromgif($file->path(true));
        $dst = imagecreatetruecolor($newwidth, $newheight);
        imagecopyresampled($dst, $src, 0, 0, 0, 0, $newwidth, $newheight, $width, $height);

        return new Giff($dst, $file);
    }
    ...
    {   
        ...
        if(imagegif($this->image,$fullPath,$quality)) {
            return true;
        }
